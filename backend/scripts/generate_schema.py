...
from models.team_members import TEAM_MEMBERS_TABLE_DDL, TEAM_MEMBERS_INDEX_DDL
from models.permission import PERMISSIONS_TABLE_DDL, PERMISSIONS_INDEXES_DDL
