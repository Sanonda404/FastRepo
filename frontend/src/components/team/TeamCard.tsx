...
export default function TeamCard({
  ...
  return (
    <RepoPermissionProvider role = {role}>
      <div className="group relative w-72 rounded-xl bg-card p-5 shadow-sm ring-2 ring-foreground/30 transition-all duration-200 hover:-translate-y-1 hover:shadow-lg">
