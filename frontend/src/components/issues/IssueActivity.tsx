...
export default function IssueActivity({
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      {assignees.length > 0 && (
        <div className="flex items-center gap-2 rounded-lg bg-background px-2.5 py-1.5 ring-1 ring-foreground/10">
...
function ActivityStat({
  ...
  return (
    <div className="inline-flex items-center gap-1.5 rounded-lg bg-background px-2.5 py-1.5 text-xs ring-1 ring-foreground/10">
